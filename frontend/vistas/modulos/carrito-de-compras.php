...
<div id="modalCheckout" class="modal fade modalFormulario" role="dialog">
	 ...
	 <div class="modal-content modal-dialog modal-lg">
		...
		<div class="modal-body modalTitulo">
          ...
          <button class="btn btn-block btn-lg btn-default backColor btnPagarMercado" style="display:none">PAGAR</button>

					<button class="btn btn-block btn-lg btn-primary backColor btnPagar">PAGAR</button>
